...
public class RoleController {
    ...
    public ResponseEntity<RoleResponseDTO> setActive(@PathVariable Long id, @RequestParam boolean active) {
        return ResponseEntity.ok(roleService.setActive(id, active));
    }
